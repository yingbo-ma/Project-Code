...
def define_discriminator(in_shape=(GENERATE_SQUARE, GENERATE_SQUARE, 3), n_classes=2):
    ...
    c_out_layer = Dense(1, activation="sigmoid", kernel_regularizer=regularizers.l2(0.1))(fe)
    c_model = Model(in_image, c_out_layer)
    c_model.compile(loss='binary_crossentropy', optimizer=Adam(lr=0.0001, beta_1=0.1), metrics=['accuracy'])

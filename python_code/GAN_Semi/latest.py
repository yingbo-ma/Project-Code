...
label_path = "/home/yingbo/Desktop/label.xlsx"
DATA_PATH = "/home/yingbo/Desktop/All_Dataset/"
...
for epoch in range(EPOCHS):
    ...
    ### 验证0，1，2和验证real、fake的0、1对训练有没有影响
    ...
    X_real = np.concatenate((X_supervised_samples_class_0, X_supervised_samples_class_1, X_supervised_samples_class_2), axis=0)
    ...
    print(f"Epoch {epoch}, c model accuarcy: {c_acc})

...
print("Start reading label data...")
...
y_test = np.concatenate((np.zeros((len(class_0_testing_data), 1)), np.ones((len(class_1_testing_data), 1)), 2*np.ones((len(class_2_testing_data), 1))), axis=0)

print("Finish reading label data.")
########################################################################################################
...
for i in range(ITERATIONS):
	...
	Xsup_real = np.concatenate((X_supervised_samples_class_0, X_supervised_samples_class_1, X_supervised_samples_class_2), axis=0)
	ysup_real = np.concatenate((Y_supervised_samples_class_0, Y_supervised_samples_class_1, Y_supervised_samples_class_2), axis=0)
	...
	X_real = np.concatenate((X_unsupervised_samples_class_0, X_unsupervised_samples_class_1, X_unsupervised_samples_class_2), axis=0)

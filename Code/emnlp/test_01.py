...
from keras.layers import Conv2D, LeakyReLU, Dropout, Flatten, TimeDistributed, LSTM, Bidirectional, Dense, Input
...
# cnn_lstm.add(AttentionDecoder(50, 2048))
# cnn_lstm.add(LSTM((150), return_sequences=True))
cnn_lstm.add(Bidirectional(LSTM((50), return_sequences=True)))
cnn_lstm.add(AttentionDecoder(50, 50))

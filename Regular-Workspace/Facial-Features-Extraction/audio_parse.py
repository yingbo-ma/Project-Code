...
if __name__ == '__main__':
    ...
    audio_source_file = r"E:\Research Data\ENGAGE\ENGAGE Recordings\Dec4-2019 - t007 t091\raw_data\6_Group.wav"
    audio = AudioSegment.from_wav(audio_source_file)
    audio_out_path = "E:\\Research Data\\ENGAGE\\ENGAGE Recordings\\Dec4-2019 - t007 t091\\clean_data\\audio_clips\\"

    transcription_path = r"E:\Research Data\ENGAGE\ENGAGE Recordings\Dec4-2019 - t007 t091\clean_data\Dec4-2019 - t007 t091_cleaned_by_Kiana.xlsx"
    ...
    for time_index in range(len(Raw_TimeStep_List) - 2):
        ...
        start_time = 60 * int(start_time_split[0]) + int(start_time_split[1])

        end_time_split = str_end_time.split(':')
        end_time = 60 * int(end_time_split[0]) + int(end_time_split[1])
    ...
    for idx, [begin, end] in enumerate(segRange):
        ...
        audio_chunk.export(audio_out_path+"audio_chunk_{}.wav".format(idx), format="wav")
        begin = end
...
if __name__ == '__main__':
    ...
    vidPath = r'E:\Research Data\ENGAGE\ENGAGE Recordings\Dec4-2019 - t007 t091\raw_data\6_Group.mp4'
    shotsPath = r'E:\Research Data\ENGAGE\ENGAGE Recordings\Dec4-2019 - t007 t091\clean_data\video_clips\%d.avi' # output path (must be avi, otherwize choose other codecs)
